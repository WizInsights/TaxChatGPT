...
let userText = null;
const API_KEY = "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"; // Paste your API key here
...
const loadDataFromLocalstorage = () => {
    ...
    const defaultText = `<div class="default-text">
                            <h1>Australian Tax Assistant</h1>
...
const getChatResponse = async (incomingChatDiv) => {
    ...
    const userMessage = lastUserInput; 
    ...
    try {
        ...
        .then(data => {
            pElement.textContent = data.chatbotResponse;
